...
<head>
    ...
    <title>{{ config('app.name', 'School Management') }} - Parent</title>
                ...
                <div class="app-header-left">
                    <div class="search-wrapper">
                        <div class="input-holder">
                            <input type="text" class="search-input" placeholder="Search children, grades...">
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ route('parent.dashboard') }}" tabindex="0" class="dropdown-item">
                                                <i class="fa fa-home mr-2"></i>Dashboard
                                            </a>
                                            <a href="{{ route('parent.children.index') }}" tabindex="0" class="dropdown-item">
                ...
                <div class="app-sidebar sidebar-shadow" style="width:280px; margin:0; padding:0;">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="{{ route('parent.dashboard') }}" class="mm-active">
                                    <i class="metismenu-icon pe-7s-home"></i>
                                    Dashboard
                                </a>
                            </li>
                            
                            <li class="app-sidebar__heading">Children</li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('parent.children.grades-overview') }}">
                                    <i class="metismenu-icon pe-7s-medal"></i>
                                    Children's Grades
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('parent.children.attendance-overview') }}">
                                    <i class="metismenu-icon pe-7s-check"></i>
                                    Children's Attendance
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('parent.children.timetable-overview') }}">
                                    <i class="metismenu-icon pe-7s-clock"></i>
                                    Children's Timetables
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('parent.children.homework-overview') }}">
                                ...
                                <div class="footer-dots">
                                    <div class="dropdown">
                                        <a aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="dot-btn-wrapper">
                                            ...
                                            <div class="badge badge-dot badge-abs badge-dot-sm badge-danger">3</div>
                                        </a>
                                            ...
                                            <div class="dropdown-menu-header mb-0">
                                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                                    ...
                                                    <div class="menu-header-content text-white">
                                                        ...
                                                        <h6 class="menu-header-subtitle">You have 3 unread messages</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-tabs-gradient">
                                                    ...
                                                    <div class="menu-header-content text-white">
                                                        ...
                                                        <h6 class="menu-header-subtitle">Monitor your children</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
