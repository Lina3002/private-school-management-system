...
<head>
    ...
    <title>{{ config('app.name', 'School Management') }} - Teacher</title>
...
<link rel="stylesheet" href="{{ asset('kero/assets/custom-sidebar-fix.css') }}">
    ...
    <!-- Bootstrap JS -->
    <script src="https://cdn.jsdeliv.net/npm/bootstrap@4.6.0/dist/js/bootstrap.bundle.min.js"></script>
</head>
<body>
                ...
                <div class="app-header-left">
                    <div class="search-wrapper">
                        <div class="input-holder">
                            <input type="text" class="search-input" placeholder="Search students, grades...">
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ route('teacher.dashboard') }}" tabindex="0" class="dropdown-item">
                                                <i class="fa fa-home mr-2"></i>Dashboard
                                            </a>
                                            <a href="{{ route('teacher.classes.index') }}" tabindex="0" class="dropdown-item">
                ...
                <div class="app-sidebar sidebar-shadow" style="width:280px; margin:0; padding:0;">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="{{ route('teacher.dashboard') }}" class="mm-active">
                                    <i class="metismenu-icon pe-7s-home"></i>
                                    Dashboard
                                </a>
                            </li>
                            
                            <li class="app-sidebar__heading">Teaching</li>
                            <li>
                                <a href="{{ route('teacher.classes.index') }}">
                                    <i class="metismenu-icon pe-7s-chalkboard"></i>
                                    My Classes
                                </a>
                            </li>
                            <li>
                                            ...
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-tabs-gradient">
                                                    ...
                                                    <div class="menu-header-content text-white">
                                                        ...
                                                        <h6 class="menu-header-subtitle">Manage your classes</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
