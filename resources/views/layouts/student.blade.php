...
<head>
    ...
    <title>{{ config('app.name', 'School Management') }} - Student</title>
                ...
                <div class="app-header-left">
                    <div class="search-wrapper">
                        <div class="input-holder">
                            <input type="text" class="search-input" placeholder="Search subjects, grades...">
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ route('student.dashboard') }}" tabindex="0" class="dropdown-item">
                                                <i class="fa fa-home mr-2"></i>Dashboard
                                            </a>
                                            <a href="{{ route('student.grades') }}" tabindex="0" class="dropdown-item">
                                                <i class="fa fa-graduation-cap mr-2"></i>My Grades
                                            </a>
                ...
                <div class="app-sidebar sidebar-shadow" style="width:280px; margin:0; padding:0;">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="{{ route('student.dashboard') }}" class="mm-active">
                            ...
                            <li class="app-sidebar__heading">Assignments</li>
                            <li>
                                ...
                                <div class="footer-dots">
                                    <div class="dropdown">
                                        <a aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="dot-btn-wrapper">
                                            ...
                                            <div class="badge badge-dot badge-abs badge-dot-sm badge-danger">2</div>
                                        </a>
                                            ...
                                            <div class="dropdown-menu-header mb-0">
                                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                                    ...
                                                    <div class="menu-header-content text-white">
                                                        ...
                                                        <h6 class="menu-header-subtitle">You have 2 unread messages</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-tabs-gradient">
                                                    ...
                                                    <div class="menu-header-content text-white">
                                                        ...
                                                        <h6 class="menu-header-subtitle">Access your academic tools</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
