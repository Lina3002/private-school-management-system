        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    ...
                    <div class="page-title-subheading">Update student information.</div>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('massar_code') is-invalid @enderror" 
                                   id="massar_code" name="massar_code" value="{{ old('massar_code', $student->massar_code) }}" required>
                            @error('massar_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('driving_service') is-invalid @enderror" 
                                ...
                                <option value="1" {{ old('driving_service', $student->driving_service ? '1' : '0') == '1' ? 'selected' : '' }}>School Bus</option>
                                <option value="0" {{ old('driving_service', $student->driving_service ? '1' : '0') == '0' ? 'selected' : '' }}>No Bus (Walking/Private)</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('emergency_phone') is-invalid @enderror" 
                                   id="emergency_phone" name="emergency_phone" value="{{ old('emergency_phone', $student->emergency_phone) }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @if($student->photo)
                                <small class="form-text text-muted">Current photo: {{ basename($student->photo) }}</small>
                            @endif
                            @error('photo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('city_of_birth') is-invalid @enderror" 
                                   id="city_of_birth" name="city_of_birth" value="{{ old('city_of_birth', $student->city_of_birth) }}">
                            @error('city_of_birth')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('country_of_birth') is-invalid @enderror" 
                                   id="country_of_birth" name="country_of_birth" value="{{ old('country_of_birth', $student->country_of_birth) }}">
